...
function cppm_mobile_nav_and_search_overlay() {
    ...
    <div class="cppm-bottom-nav" style="--brand: <?php echo esc_attr( $ui_brand ); ?>;">
        ...
        <!--
        <a href="<?php echo esc_url( home_url('/about-us') ); ?>" class="cppm-nav-item">
        ...
        -->
        <a href="<?php echo esc_url( 'https://api.whatsapp.com/send?phone=919651140204&text=Hii' ); ?>" class="cppm-nav-item">
