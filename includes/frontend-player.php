...
function cppm_render_playlist( $atts ) {
    ...
    if ( isset($_GET['course_id']) && !empty($_GET['course_id']) ) {
        $playlist_id = intval($_GET['course_id']);
    } else {
    ...
    if ( $playlist_id === 0 ) {
        return '<div style="padding:40px; text-align:center; background:#f8fafc; border-radius:12px; border:1px solid #e2e8f0;"><h3 style="color:#0f172a; margin-top:0;">Course Not Found</h3><p>Missing Course ID in URL or Shortcode.</p></div>';
    }
    ...
    <div id="playlist-<?php echo $uid; ?>" class="cppm-container" data-uid="<?php echo $uid; ?>" data-pid="<?php echo $playlist_id; ?>" data-total="<?php echo $total_vids; ?>">
        ...
        <div class="cppm-player-container">
            ...
            <div class="cppm-discussion-area">
                <?php 
                $get_comments_args = array( 'comment_post_ID' => get_the_ID(), 'status' => 'approve', 'order' => 'DESC' );
